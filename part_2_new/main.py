...
len_slot = len(lang.slot2id)
len_int = len(lang.intent2id)
vocab_len = len(lang.word2id)

# print("train_raw: ", train_raw[0])

config = BertConfig.from_pretrained('bert-base-uncased')  # Load BERT configuration

model = JointBERT(hid_size, len_int, len_slot, config).to(device)
...
# # - Data loading and preprocessing: The script loads the ATIS training and test datasets. It then stratifies 
...
# # distribution between -0.01 and 0.01, and biases are set to 0.01.